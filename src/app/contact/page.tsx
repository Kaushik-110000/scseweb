...
import { Mail, Phone, MapPin, Linkedin, Instagram, Facebook, Twitter, Send, User, AtSign } from "lucide-react"
...
const teamMembers = [
  {
    ...
    linkedin: "https://www.linkedin.com/in/amrish-yadav-363b63289?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
...
export default function ContactPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.content.trim()) newErrors.content = "Please enter your query or feedback"
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (name === "number") {
      if (value.startsWith("+91 ")) {
        ...
        setFormData((prev) => ({ ...prev, [name]: "+91 " + value.replace("+91 ", "") }))
      }
    } else {
      setFormData((prev) => ({ ...prev, [name]: value }))
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSubmitting(true)
      ...
      try {
        const response=await axios.post('/api/contactUs', {...formData,number:number1});
  ...
  return (
    <div className="relative min-h-screen bg-black text-white">
      ...
      <div className="absolute inset-0 z-0">
        <Image src="https://images.unsplash.com/photo-1524334228333-0f6db392f8a1?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGJsYWNrJTIwYmFja2dyb3VuZHxlbnwwfHwwfHx8MA%3D%3D" alt="College Fest Background" fill priority className="object-cover" />
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeIn} className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex justify-center mt-8 space-x-4">
              <a href="https://www.instagram.com/scse.nitjsr/" className="bg-white/10 hover:bg-white/20 p-3 rounded-full transition-colors" target="_blank" rel="noopener noreferrer">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-black/50 border ${errors.name ? "border-red-500" : "border-purple-500/30"} rounded-xl pl-10 pr-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full bg-black/50 border ${errors.email ? "border-red-500" : "border-purple-500/30"} rounded-xl pl-10 pr-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent`}
              ...
              <div className="mb-6 space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full bg-black/50 border ${errors.number ? "border-red-500" : "border-purple-500/30"} rounded-xl pl-10 pr-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent`}
                    placeholder="+91 9876543210"
                  />
                </div>
                {errors.number && <p className="text-sm text-red-400 mt-1">{errors.number}</p>}
                <p className="text-xs text-gray-400">Format: +91 followed by 10 digits (e.g., +91 9876543210)</p>
              </div>

              <div className="mb-8 space-y-2">
                <label htmlFor="content" className="block text-sm font-medium text-gray-200">
                  Your Query or Feedback <span className="text-pink-500">*</span>
                </label>
                <textarea
                  id="content"
                  name="content"
                  ...
                  onChange={handleChange}
                  rows={5}
                  className={`w-full bg-black/50 border ${errors.content ? "border-red-500" : "border-purple-500/30"} rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent`}
