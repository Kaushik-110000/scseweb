...
function Gallery() {
  ...
  const events = [
    ...
    },
    {
      ...
      date: "FEB, 2025",
      description: "Ultimate cricket showdown as teams compete for glory in the second season of the SCSE Premier League!"
    },
    {
      id: 3,
      ...
      date: "2024",
      description: "A thrilling adventure where participants solve clues, explore the campus, and race against time to win exciting rewards."
    },
    {
      id: 4,
      ...
      title: "Dodgeball",
      date: "2024",
      description: "Fast-paced and action-packed dodgeball tournament where agility and teamwork lead to victory."
    },
    {
      id: 5,
      ...
      date: "2024",
      description: "The inaugural season of our highly anticipated cricket tournament, bringing intense competition and unforgettable moments."
    },
    {
      id: 6,
  ...
  return (
    <div className="relative min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 px-4 py-20">
        {/* Added Font links */}
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;700;800&family=Inter:wght@400;500&display=swap" />
