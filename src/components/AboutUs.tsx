...
function AboutUs() {
  return (
    <motion.div
      className="relative min-h-screen z-10 mt-20 h-full px-2 text-white md:ml-12 flex flex-col items-center md:mt-5"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:space-x-10 w-full">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left flex flex-col items-center justify-center md:items-start">
          ...
          <p className="text-lg text-gray-300 max-w-xl px-4 md:px-0 leading-relaxed">
            The Society of Computer Science and Engineering (SCSE) is a dynamic
            community of tech enthusiasts, innovators, and learners. We foster a
            culture of knowledge-sharing, problem-solving, and creativity to
